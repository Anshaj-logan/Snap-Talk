...
import 'package:talk_snap/features/user/presentaion/pages/login_page.dart';
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          ...
          children: [
            const Center(child: Text("Welcome to Snap Talk ", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: tabColor),),),
